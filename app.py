...
if page == "🏠 Home":
    ...
    Is dashboard ka goal hai **high-risk customers identify karna** 
    taake retention strategies apply ki ja sakein.
...
# ════════════════════════════════
    ...
    with tab2:
        col = st.selectbox("Select Column", ['Contract', 'PaymentMethod', 
...
# ════════════════════════════════
    ...
    model_choice = st.selectbox("Select Model", [
        ...
        "Random Forest", "KNN", "SVM", "Gradient Boosting"
    ])
...
# ════════════════════════════════
    ...
    st.markdown("Customer ki details bharo aur predict karo!")
